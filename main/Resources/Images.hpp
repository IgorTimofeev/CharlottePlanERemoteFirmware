...
#include "Resources/Images/MenuIconMFDAutopilotGyroImage.hpp"
...
#include "Resources/Images/MenuIconPowerImage.hpp"
...
namespace pizda {
	class Images {
		public:
			...
			constexpr static MenuIconMFDCameraImage menuIconMFDCamera {};
			constexpr static MenuIconMFDCameraResetImage menuIconMFDCameraReset {};
			...
			constexpr static MenuIconPowerImage menuIconPower {};
